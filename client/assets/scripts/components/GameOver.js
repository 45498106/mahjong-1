cc.Class({
    ...
    onGameOver(data){
        ...
        // if(cc.vv.gameNetMgr.conf.type == "tzmj") {
        //     this.onGameOver_TZMJ(data);
    ...
    onGameOver_XZDD(data){
        ...
        for(var i = 0; i < 4; ++i){
            ...
            cc.vv.mahjongmgr.sortMJWithDepai(userData.holds, cc.vv.gameNetMgr.depai);
